...
### It opens straight into the morning

There is no lock screen, no push notification to tap, no app to hunt for, no onboarding. The prototype opens directly on Today, the morning command center, at 6:52. The status pill at the top of the phone is a static, decorative detail, not a live notification. The first beat is the screen assembling itself: the cards rise in with a soft settle, and the eye lands first on the greeting, "Good morning, Dana," and on the trust ledger directly under it.
...
Below the ledger sits the altitude toggle, My deals or My team, and under it the triage: one focus card open, the rest collapsed into a quiet queue, ordered by severity. The section is labeled "Needs your judgment," with a soft note, "one at a time." The morning is deliberately calm, and a presenter toggle (Calm or Heavy) lets you show how the same surface behaves on a hard day.
